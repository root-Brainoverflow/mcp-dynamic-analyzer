...
| R6: 안정성 | `scanners/r6_stability.py` | ✅ 즉시 동작. `outcome=client_timeout`을 hang finding으로 직접 변환. circuit breaker로 hang 카테고리 단축 |
...
| **응답 echo 필터** | `payloads/_response_filters.py` | ✅ Pydantic / jsonschema / postgres LINE / MySQL near 4종 echo 패턴 strip |
